namespace FibonacciHeaps
{
    ...
    /// <summary>
    /// Implements the Fibonacchi heap class with the key of type float.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class FibonacciHeapfloatKey<T> : FibonacciHeap<T, float>
    {
        /// <summary>
        /// Constructor. 
        /// Initializes the new instance.
        /// Declares the float.NegativeInfinity as minimum possible key value.
        /// </summary>
        public FibonacciHeapfloatKey()
            : base(float.NegativeInfinity)
        {
        }
    }
    /*************************************************************************/
    ...
    /// <summary>
    /// Implementation of the Fibonacci heap node with key of type float.
    /// </summary>
    /// <typeparam name="T">Type of the data to be stored.</typeparam>
    public class FibonacciHeapNodefloatKey<T> : FibonacciHeapNode<T, float>
    {
        public FibonacciHeapNodefloatKey(T data, float key)
            : base(data, key)
        {
        }
    }
